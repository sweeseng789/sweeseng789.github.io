 ...
 */
function SmartHTMLSubStr(src, length, suffix)
{
...
function ParseXmlToHTML(toParse)
{
    var tagName = $(toParse).prop("tagName");

    if (toParse == undefined || tagName == undefined)
        return "";

        ParseXmlToHTML(toParse);
}